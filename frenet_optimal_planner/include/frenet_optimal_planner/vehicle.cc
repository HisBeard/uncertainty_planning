...
namespace fop
{
  ...
  double Vehicle::max_acceleration() { return max_speed()/7.0; };
  double Vehicle::max_deceleration() { return -max_speed()/5.0; };
  double Vehicle::max_steering_angle() { return deg2rad(70); };
  double Vehicle::max_steering_rate() { return max_steering_angle()/1.0; }; 
  double Vehicle::max_curvature_front() { return 1.0; };
  double Vehicle::max_curvature_rear() { return 1.0; };
